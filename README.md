...
Opis
<IP>
Głęboki skan portów + detekcja OS
<IP,IP,...>
Wiele celów naraz
i <IP>
Identity Scan — mDNS, NetBIOS, SMB, UPnP
snmp <IP>
SNMP Scan — lokalizacja, kontakt admina, interfejsy
v <IP>
Vuln-Scan NSE — CVE, Heartbleed, EternalBlue
b <IP>
Banner Grabber — HTTP/HTTPS + raport HTML
h
Pomoc
q
Wyjście
...
Wykrywa aktywny interfejs sieciowy (wlan0 → eth0 → usb0)
Przeprowadza ping sweep całej podsieci
Wyświetla listę aktywnych urządzeń z adresami MAC i producentami
...
�
Stworzony z ♥ przez MR.ROOT | NetHunter Edition 
