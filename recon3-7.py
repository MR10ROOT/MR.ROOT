#!/usr/bin/env python3
"""
MR.ROOT Scanner v3.6 — NetHunter Edition | REDHUNT-16-BETA
...
{C.GREEN}{C.BOLD}
  ...
  ██║ ╚═╝ ██║██║  ██║    ██║  ██║╚██████╔╝╚██████╔╝   ██║
  ╚═╝     ╚═╝╚═╝  ╚═╝    ╚═╝  ╚═╝ ╚═════╝  ╚═════╝    ╚═╝{C.RESET}
{C.DIM}        Mobilny Skaner Sieci | by MR.ROOT | NetHunter Edition v3.7 REDHUNT-16-BETA{C.RESET}
"""
...
def sql_scan(url):
    ...
    report_data = {
        ...
        "scanner_version":  "MR.ROOT v3.6 REDHUNT-16-BETA"
    }
...
def main():
    ...
    parser = argparse.ArgumentParser(description="MR.ROOT Scanner v3.7 REDHUNT-16-BETA")
