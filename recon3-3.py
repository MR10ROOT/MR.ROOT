#!/usr/bin/env python3
"""
MR.ROOT Scanner v3.2 — NetHunter Edition
...
{C.GREEN}{C.BOLD}
  ...
  ██║ ╚═╝ ██║██║  ██║    ██║  ██║╚██████╔╝╚██████╔╝   ██║
  ╚═╝     ╚═╝╚═╝  ╚═╝    ╚═╝  ╚═╝ ╚═════╝  ╚═════╝    ╚═╝{C.RESET}
{C.DIM}        Mobilny Skaner Sieci | by MR.ROOT | NetHunter Edition v3.2{C.RESET}
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="MR.ROOT Scanner v3.2")
